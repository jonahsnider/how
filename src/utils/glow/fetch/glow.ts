import type {DESIRED_GLOW_VERSION} from '../../../options.js';
...
export type BinaryArchive = `glow_${typeof DESIRED_GLOW_VERSION}_${`${'Darwin_x86_64' | `${Unixes}_${Arch}`}.tar.gz` | `Windows_${'i386' | 'x86_64'}.zip`}`;
